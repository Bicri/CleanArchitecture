...
public class GetVideosListQueryHandler : IRequestHandler<GetVideosListQuery, List<VideosVm>>
{
    ...
    {
        //var videoList = await _videoRepository.GetAllVideoByUserName(request._userName);
        var videoList = await _unitOfWork.VideoRepository.GetAllVideoByUserName(request._userName);
